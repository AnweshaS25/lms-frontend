  ...
  return (
    <aside className="bg-gray-900 text-gray-200 w-64 min-h-screen p-6 space-y-4 hidden lg:block">
      ...
      <nav className="space-y-2 text-sm">
        <a href="#" className="block hover:bg-pink-800 px-3 py-2 rounded">Dashboard</a>
        <a href="#" className="block hover:bg-pink-800 px-3 py-2 rounded">Courses</a>
        <a href="#" className="block hover:bg-pink-800 px-3 py-2 rounded">Profile</a>
